...
Also reports our own bar (recall >= 0.9, zero permission failures) alongside
team_brain.evaluate's built-in 0.8 threshold, since the task's acceptance bar
...
def main() -> int:
    ...
    print(f"Task bar: recall >= {OUR_RECALL_BAR} AND permission_failures == 0")
