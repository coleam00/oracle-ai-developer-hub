...
exactly this and called them _LLM-free retrieval primitives_.
...
Put up `docs/team-brain-security.png`. Cerebras nails retrieval and leaves the lock
...
Cerebras-style "Projects" turned into _enforced_ grants, `who_knows` for org
